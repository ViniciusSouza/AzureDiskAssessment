function GetDiskResult{
  ...
  foreach($obj in $returnVolumes){
      ...
      $ResultJon = "{""Disk"":"""+ $obj.Disk +""", ""Lun"":"""+$obj.Lun+""", ""DiskSize"":"""+$obj.DiskSize+""", ""DiskModel"":"""+$obj.DiskModel+""", ""Partition"":"""+$obj.Partition+""", ""RawSize"":"""+$obj.RawSize+""", ""DriveLetter"":"""+$obj.DriveLetter+""", ""VolumeName"":"""+$obj.VolumeName+""", ""Size"":"""+$obj.Size+""", ""FreeSpace"":"""+$obj.FreeSpace+""", ""VolumeUsed"":"""+$obj.VolumeUsed+"""}"
